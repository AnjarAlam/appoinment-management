          ...
          <div className="flex-1 overflow-auto" style={{ background: 'var(--surface)' }}>
            <div className="p-8 max-w-2xl mx-auto">
              ...
              >
                ...
                <InputField label="Department" value={profile.department} field="department" />
                ...
                <InputField label="Languages" value={profile.languages} field="languages" />
              </div>

              {/* Statistics */}
              <div className="grid grid-cols-3 gap-4">
                {[
                  { label: 'Appointments Booked', value: '1,245' },
                  { label: 'Patients Registered', value: '342' },
