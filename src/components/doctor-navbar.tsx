...
import { Search, Bell, Moon, Sun, Settings, User, LogOut, Stethoscope } from 'lucide-react';
  ...
  return (
    <div className={`h-16 flex items-center justify-between px-6 border-b sticky top-0 z-50 transition-all duration-300 backdrop-blur-md
      ...
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          >
            <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center text-white font-semibold shadow-inner">
              DR
            </div>
            <div className="hidden sm:block text-left">
              <p className="text-sm font-medium text-slate-900 dark:text-white">Dr. Priya Sharma</p>
              <p className="text-xs text-slate-500 dark:text-slate-400 -mt-0.5">Ayurvedic Specialist</p>
            </div>
          </button>
          ...
          {isUserMenuOpen && (
            <div className={`absolute right-0 mt-3 w-64 rounded-3xl shadow-xl py-2 z-50 border transition-all
              ...
              <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-700">
                <p className="font-medium text-slate-900 dark:text-white">Dr. Priya Sharma</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">priya.sharma@clinic.com</p>
              </div>
